    ...
    <div class="col-lg-12">
        ...
        <div class="card">
            <div class="card-header d-flex align-items-center">
                ...
                <div>
                    <a href="<?= site_url('admin/jenis_peraturan/new') ?>" class="btn btn-primary">Add New Row</a>
                </div>
            </div>
            <div class="card-body">
                                    ...
                                    <td>
                                        <div class="dropdown d-inline-block">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end">
                                                <li>
                                                    <a href="<?= site_url('admin/jenis_peraturan/edit/' . $k->id) ?>" class="dropdown-item"><i class="ri-pencil-fill align-bottom me-2 text-muted"></i> Edit</a>
                                                </li>
                                                <li>
        ...
        Swal.fire({
            ...
            preConfirm: function(email) {
                return new Promise(function(resolve, reject) {
                    $.ajax({
                        url: "<?= site_url('admin/jenis_peraturan/delete/') ?>" + id,
                        headers: {
