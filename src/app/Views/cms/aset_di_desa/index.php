...
<script>
    ...
    table = $('#table').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: '<?= $apiDomain ?>/api/datatable/aset_di_desa',
        ...
        columns: [{
            ...
            <ul class="dropdown-menu dropdown-menu-end">`;
                    ...
                    html += `<li><a href="<?= site_url('admin/aset_di_desa/') ?>edit/` + data + `" class="dropdown-item edit-item-btn"><i class="ri-pencil-fill align-bottom me-2 text-muted"></i> Edit</a></li>`;
    ...
    function detailData(id) {
        $('.formDetail').load('<?= site_url('admin/aset_di_desa/show/') ?>' + id, function(response, status, xhr) {
            if (status == "error") {
