...
class PenggunaanLahanController extends BaseAdminController
{
    use ResponseTrait;
    protected $var = [];
    protected $apiDomain;
    ...
    {
        $this->var['viewPath'] = 'cms/penggunaan_lahan/';
        $this->apiDomain = getenv('API_DOMAIN');
        $this->titleHeader = 'Penggunaan Lahan';
    }
    ...
    public function create()
    {
        ...
        if ($response->getStatusCode() == 201) {
            return redirect()->to('/admin/penggunaan_lahan/index')->with('success', 'Data berhasil disimpan.');
        } else {
    ...
    public function edit($id = null)
    {
        ...
        if ($id) {
            $dataRequest = [
                'method' => 'GET',
                'api_path' => '/api/penggunaan_lahan/edit/' . $id,
            ];
            $response = $this->request($dataRequest);
            if ($response->getStatusCode() == 200) {
    ...
    public function update($id = null)
    {
        ...
        $dataRequest = [
            'method' => 'POST',
            'api_path' => '/api/penggunaan_lahan/update/' . $id,
            'form_params' => [
                'nama' => $nama,
            ],
        ];
    ...
    public function delete($id = null)
    {
        ...
        if ($id) {
            $dataRequest = [
                'method' => 'POST',
                'api_path' => '/api/penggunaan_lahan/delete/' . $id,
            ];
